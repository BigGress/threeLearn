...
var shapeMaterial1 = new THREE.MeshNormalMaterial({
    side:THREE.DoubleSide
});

var shapeMaterial2 = new THREE.MeshBasicMaterial({
    //color:0x000000,
    //wireframe:true,
    transparent:true,
    opacity:0.3
...
var shape = new THREE.SceneUtils.createMultiMaterialObject(new THREE.ExtrudeGeometry(drawShape().shape,{
    amount:10,
    bevelThickness:2,
    bevelSize:1,
    bevelSegments:3,
