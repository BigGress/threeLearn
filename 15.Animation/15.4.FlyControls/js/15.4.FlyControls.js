...
//绑定轨迹球控件
var trackballcontrols = new THREE.FlyControls(camera);
trackballcontrols.movementSpeed = 25;
trackballcontrols.domElement = document.getElementById("webgl");
trackballcontrols.rollSpeed = Math.PI/24;
trackballcontrols.autoForward = true;
trackballcontrols.dragToLook = false;
